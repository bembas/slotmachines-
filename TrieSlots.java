...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(trie.get(line2));
        System.out.println(trie.get(line3));
        System.out.println(trie.get(line4));

        int[] line5 = {3,4,5,6,7};
        int val5 = 420;
        trie.put(line5, val5);
        System.out.println(trie.get(line5));

        int[] line6 = {9,9,9,9};
        System.out.println(trie.get(line6));
}
}
